...
def load_patrol_template(template_id: str, overrides: dict[str, Any] | None = None) -> PatrolPackConfig:
    path = _TEMPLATES.get(template_id)
    if path is None:
        raise BadRequestError("Unknown Patrol template", error_key="patrol.unknownTemplate")
