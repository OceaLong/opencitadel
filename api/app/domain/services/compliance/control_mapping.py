...
CONTROLS: list[Control] = [
    ...
    Control(
        ...
        "A.5.18",
        "访问权限",
        "应Provisioning/Deprovisioning 访问权限",
        "管理员分配角色与配额",
        "privileged_access_control",
    ),
    Control(
