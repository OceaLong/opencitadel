...
from app.interfaces.service_dependencies import get_memory_service, get_runtime_policy_reader
...
async def create_memory(
    ...
    created = await memory_service.create_entry(
        entry,
        owner_scope=ctx.scope,
        policy=active.revision.policy.memory,
    )
...
@memory_router.delete("/{entry_id}", response_model=Response[dict | None])
