...
- [ ] Knowledge-base ingestion change → `knowledge-base-ingestion.md` (+ zh), tutorial 02 (+ zh), `execution-kernel.md` (+ zh)
- [ ] Upload limit change → `nginx/README.md` (+ zh), `config-source-governance.md` (+ zh), `deployment.md` (+ zh)
