...
```bash
# ==================== 对象存储配置 ====================
# STORAGE_PROVIDER=cos   # 默认腾讯云 COS；本地/自建可设为 minio
COS_SECRET_ID=your_cos_secret_id_here       # 腾讯云 SecretId（cos 模式）
...
# MinIO（STORAGE_PROVIDER=minio 时生效；docker-compose 已内置 manus-minio）
# MINIO_ENDPOINT=manus-minio:9000
